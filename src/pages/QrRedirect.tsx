...
import { QrCode as QrIcon, Loader2, AlertTriangle, ExternalLink } from 'lucide-react';
        ...
        <div className="text-center max-w-sm animate-fade-in">
          ...
          {state === 'loading' ? (
            <>
              ...
              <h1 className="text-xl font-bold text-slate-900 mb-2">Verificando QR Code...</h1>
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 to-slate-100 p-6">
      <div className="text-center max-w-sm animate-fade-in">
        ...
        <h1 className="text-2xl font-bold text-slate-900 mb-2">QR Code não disponível</h1>
        <p className="text-sm text-slate-500 mb-6">
          Este QR Code não existe, está desativado ou não possui um estabelecimento associado no momento.
        </p>
